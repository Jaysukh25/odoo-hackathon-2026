    ...
    <?php if(auth()->guard()->check()): ?>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <?php if(auth()->user()->role === 'manager' || auth()->user()->role === 'dispatcher'): ?>
                    <a href="<?php echo e(route('vehicles.index')); ?>"
                        class="sidebar-link <?php echo e(request()->routeIs('vehicles.*') ? 'active' : ''); ?>">
                        <i class="bi bi-truck"></i>
                        Vehicles
                    </a>
                <?php endif; ?>

                <?php if(auth()->user()->role === 'manager' || auth()->user()->role === 'safety'): ?>
                    <a href="<?php echo e(route('drivers.index')); ?>"
                        class="sidebar-link <?php echo e(request()->routeIs('drivers.*') ? 'active' : ''); ?>">
                ...
                <?php if(auth()->user()->role === 'manager' || auth()->user()->role === 'dispatcher'): ?>
                    <a href="<?php echo e(route('trips.index')); ?>"
                        class="sidebar-link <?php echo e(request()->routeIs('trips.*') ? 'active' : ''); ?>">
                ...
                <?php if(auth()->user()->role === 'manager'): ?>
                    <a href="<?php echo e(route('maintenance.index')); ?>"
                        class="sidebar-link <?php echo e(request()->routeIs('maintenance.*') ? 'active' : ''); ?>">
                        <i class="bi bi-tools"></i>
                        Maintenance
                    </a>

                    <a href="<?php echo e(route('fuel.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('fuel.*') ? 'active' : ''); ?>">
                        <i class="bi bi-fuel-pump"></i>
                        Fuel
                    </a>
                <?php endif; ?>

                <?php if(auth()->user()->role === 'manager' || auth()->user()->role === 'finance'): ?>
                    <a href="<?php echo e(route('analytics')); ?>"
                        class="sidebar-link <?php echo e(request()->routeIs('analytics') ? 'active' : ''); ?>">
...
</html><?php /**PATH D:\Hack\F_FleetFlow\resources\views/layouts/app.blade.php ENDPATH**/ ?>